...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1345: x0 => new Blob(x0),
      _1346: () => new FileReader(),
      _1347: (x0,x1) => x0.item(x1),
      _1348: (x0,x1) => x0.readAsText(x1),
      _1349: x0 => x0.createRange(),
      _1350: (x0,x1) => x0.selectNode(x1),
      _1351: x0 => x0.getSelection(),
      _1352: x0 => x0.removeAllRanges(),
      _1353: (x0,x1) => x0.addRange(x1),
      _1354: (x0,x1) => x0.createElement(x1),
      _1355: (x0,x1) => x0.append(x1),
      _1356: (x0,x1,x2) => x0.insertRule(x1,x2),
      _1357: (x0,x1) => x0.add(x1),
      _1358: x0 => x0.preventDefault(),
      ...
      _1361: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1362: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1369: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1378: (x0,x1) => x0.readAsArrayBuffer(x1),
      _1379: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1379(f,arguments.length,x0) }),
      _1380: (x0,x1,x2) => x0.removeEventListener(x1,x2),
      ...
      _1413: (o, p, r) => o.replaceAll(p, () => r),
      _1414: (o, p, r) => o.replace(p, () => r),
      _1415: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1416: s => s.toUpperCase(),
      _1417: s => s.trim(),
      _1418: s => s.trimLeft(),
      _1419: s => s.trimRight(),
      _1420: (string, times) => string.repeat(times),
      _1421: Function.prototype.call.bind(String.prototype.indexOf),
      _1422: (s, p, i) => s.lastIndexOf(p, i),
      _1423: (string, token) => string.split(token),
      _1424: Object.is,
      _1425: o => o instanceof Array,
      _1426: (a, i) => a.push(i),
      _1429: (a, l) => a.length = l,
      _1430: a => a.pop(),
      _1431: (a, i) => a.splice(i, 1),
      _1432: (a, s) => a.join(s),
      _1433: (a, s, e) => a.slice(s, e),
      _1435: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1436: a => a.length,
      ...
      _1442: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1444: o => o instanceof Uint8Array,
      _1445: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1446: o => o instanceof Int8Array,
      _1447: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1448: o => o instanceof Uint8ClampedArray,
      _1449: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1450: o => o instanceof Uint16Array,
      _1451: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1452: o => o instanceof Int16Array,
      _1453: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1454: o => o instanceof Uint32Array,
      _1455: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1456: o => o instanceof Int32Array,
      _1457: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1459: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1460: o => o instanceof Float32Array,
      _1461: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1462: o => o instanceof Float64Array,
      _1463: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1464: (t, s) => t.set(s),
      _1465: l => new DataView(new ArrayBuffer(l)),
      _1466: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1467: o => o.byteLength,
      _1468: o => o.buffer,
      _1469: o => o.byteOffset,
      _1470: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1471: (b, o) => new DataView(b, o),
      _1472: (b, o, l) => new DataView(b, o, l),
      _1473: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1474: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1475: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1476: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1477: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1478: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1479: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1480: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1481: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1482: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1483: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1484: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1487: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1488: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1489: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1490: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1491: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1492: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1505: (ms, c) =>
      ...
      _1590: (x0,x1,x2) => x0.close(x1,x2),
      _1592: x0 => x0.close(),
      _1595: () => new AbortController(),
      _1596: x0 => x0.abort(),
      _1597: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1598: (x0,x1) => globalThis.fetch(x0,x1),
      _1599: (x0,x1) => x0.get(x1),
      _1600: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1600(f,arguments.length,x0,x1,x2) }),
      _1601: (x0,x1) => x0.forEach(x1),
      _1602: x0 => x0.getReader(),
      _1603: x0 => x0.cancel(),
      _1604: x0 => x0.read(),
      _1605: x0 => x0.random(),
      ...
      _1627: () => globalThis.document,
      _1628: () => globalThis.window,
      _1633: (x0,x1) => { x0.height = x1 },
      _1635: (x0,x1) => { x0.width = x1 },
      _1638: x0 => x0.head,
      _1639: x0 => x0.classList,
      _1643: (x0,x1) => { x0.innerText = x1 },
      _1644: x0 => x0.style,
      _1646: x0 => x0.sheet,
      _1657: x0 => x0.offsetX,
      _1658: x0 => x0.offsetY,
      _1659: x0 => x0.button,
      _1783: (x0,x1) => { x0.draggable = x1 },
      _1799: x0 => x0.style,
      _2052: x0 => x0.content,
      _2158: (x0,x1) => { x0.download = x1 },
      _2183: (x0,x1) => { x0.href = x1 },
      _2728: (x0,x1) => { x0.accept = x1 },
      _2742: x0 => x0.files,
      _2768: (x0,x1) => { x0.multiple = x1 },
      _2786: (x0,x1) => { x0.type = x1 },
      _3036: (x0,x1) => { x0.src = x1 },
      _3038: (x0,x1) => { x0.type = x1 },
      _3042: (x0,x1) => { x0.async = x1 },
      _3056: (x0,x1) => { x0.charset = x1 },
      _3505: () => globalThis.window,
      _3548: x0 => x0.location,
      _3567: x0 => x0.navigator,
      _3839: x0 => x0.href,
      _3842: x0 => x0.protocol,
      _3844: x0 => x0.host,
      _3935: x0 => x0.clipboard,
      _3956: x0 => x0.userAgent,
      _4007: x0 => x0.data,
      _4383: x0 => x0.readyState,
      _4392: x0 => x0.protocol,
      _4396: (x0,x1) => { x0.binaryType = x1 },
      _4399: x0 => x0.code,
      _4400: x0 => x0.reason,
      _6108: x0 => x0.signal,
      _6169: x0 => x0.firstChild,
      _6180: () => globalThis.document,
      _6596: (x0,x1) => { x0.id = x1 },
      _6623: x0 => x0.children,
      _7942: x0 => x0.value,
      _7944: x0 => x0.done,
      _8124: x0 => x0.size,
      _8125: x0 => x0.type,
