...
var ttcpInstructions string

//go:embed instructions/TTCPComponents.csv
var ttcpComponents string
...
func (device *ttcp) loadLANDetails(name string) bool {
...
func (device *ttcp) initializeDevice(name string) {
	device.loadLANDetails(name)
	device.connection.Configure(" ", "\n", false, true)
	device.loadCommands()
}

func (device *ttcp) setCarrierOn(component string) utils.CommandResponse {
...
func (device *ttcp) setCarrierOff(component string) utils.CommandResponse {
	var mnemonics = make([]string, 0)
	var arguments = make([]string, 0)
...
func (device *ttcp) setModulationOn(component string) utils.CommandResponse {
	var mnemonics = make([]string, 0)
	var arguments = make([]string, 0)
...
func (device *ttcp) setModulationOff(component string) utils.CommandResponse {
	var mnemonics = make([]string, 0)
	var arguments = make([]string, 0)
...
func (device *ttcp) setFrequencyDeviationTC(component string, deviation float64) utils.CommandResponse {
	var mnemonics = make([]string, 0)
	var arguments = make([]string, 0)
...
func (device *ttcp) setFrequencyDeviationTone(component string, deviation float64) utils.CommandResponse {
	var mnemonics = make([]string, 0)
	var arguments = make([]string, 0)

	mnemonics = append(mnemonics, "setPeakFrequencyDeviationTone")
	arguments = append(arguments, fmt.Sprintf("%.2f", deviation))
	var cmds = device.getCommands(mnemonics, arguments, make([]string, len(mnemonics)))
	comp, ok := device.components[component]
	if !ok {
...
func (device *ttcp) setModIndexTC(component string, modIndex float64) utils.CommandResponse {
	var mnemonics = make([]string, 0)
	var arguments = make([]string, 0)
...
func (device *ttcp) setModIndexTone(component string, modIndex float64) utils.CommandResponse {
	var mnemonics = make([]string, 0)
	var arguments = make([]string, 0)

	mnemonics = append(mnemonics, "setModIndexTone")
	arguments = append(arguments, fmt.Sprintf("%.2f", modIndex))
	var cmds = device.getCommands(mnemonics, arguments, make([]string, len(mnemonics)))
	comp, ok := device.components[component]
	if !ok {
...
func (device *ttcp) setRangingToneFrequency(frequency float64) utils.CommandResponse {
	var mnemonics = make([]string, 0)
	var arguments = make([]string, 0)

	mnemonics = append(mnemonics, "setToneFrequency")
...
func (device *ttcp) setOnlyTC(component string) utils.CommandResponse {
	var mnemonics = make([]string, 0)
	var arguments = make([]string, 0)
	var argumentValue = 0x80001000
...
func (device *ttcp) setOnlyRanging(component string) utils.CommandResponse {
	var mnemonics = make([]string, 0)
	var arguments = make([]string, 0)
...
func (device *ttcp) setTCAndRanging(component string) utils.CommandResponse {
	var mnemonics = make([]string, 0)
	var arguments = make([]string, 0)
	var argumentValue = 0x80001800
...
func (device *ttcp) setSweepRate(component string, sweepRate float64) utils.CommandResponse {
	var mnemonics = make([]string, 0)
	var arguments = make([]string, 0)
...
func (device *ttcp) setSweepStep(component string, sweepStep float64) utils.CommandResponse {
	var mnemonics = make([]string, 0)
	var arguments = make([]string, 0)
...
func (device *ttcp) triggerSweep(component string) utils.CommandResponse {
	var mnemonics = make([]string, 0)
	var arguments = make([]string, 0)

	mnemonics = append(mnemonics, "setSweepStepTrigger")
	arguments = append(arguments, "0")
	var cmds = device.getCommands(mnemonics, arguments, make([]string, len(mnemonics)))
	comp, ok := device.components[component]
	if !ok {
...
func (device *ttcp) enableDoppler(component string) utils.CommandResponse {
	var mnemonics = make([]string, 0)
	var arguments = make([]string, 0)
...
func (device *ttcp) startSweep(component string) utils.CommandResponse {
	var mnemonics = make([]string, 0)
	var arguments = make([]string, 0)
...
func (device *ttcp) stopSweep(component string) utils.CommandResponse {
	var mnemonics = make([]string, 0)
	var arguments = make([]string, 0)
...
func (device *ttcp) sweepHold(component string) utils.CommandResponse {
	var mnemonics = make([]string, 0)
	var arguments = make([]string, 0)
...
func (device *ttcp) sweepContinuous(component string) utils.CommandResponse {
	var mnemonics = make([]string, 0)
	var arguments = make([]string, 0)
...
func (device *ttcp) setSweepRange(component string, sweepRange float64) utils.CommandResponse {
	var mnemonics = make([]string, 0)
	var arguments = make([]string, 0)
...
func (device *ttcp) setFrequency(component string, frequency float64) utils.CommandResponse {
	var mnemonics = make([]string, 0)
	var arguments = make([]string, 0)
...
func (device *ttcp) setPower(component string, power float64) utils.CommandResponse {
	var mnemonics = make([]string, 0)
	var arguments = make([]string, 0)
...
func (device *ttcp) setChipRate(component string, chipRate float64) utils.CommandResponse {
	var mnemonics = make([]string, 0)
	var arguments = make([]string, 0)
...
func (device *ttcp) checkConnection() utils.CommandResponse {
	var mnemonics = make([]string, 0)
	var arguments = make([]string, 0)
	...
	arguments = append(arguments, "0")
	var cmds = device.getCommands(mnemonics, arguments, make([]string, len(mnemonics)))
	comp, ok := device.components["IFM-1"]
	if !ok {
		return getErrorResponse("Component name not proper")
	}
	packet := device.getCommandPacket(cmds[0], comp)
...
func (device *ttcp) setDopplerCompensationEnable() utils.CommandResponse {
	return device.enableDoppler("IFM-1")
}

func (device *ttcp) setDopplerCompensationDisable() utils.CommandResponse {
	return device.stopSweep("IFM-1")
}

func (device *ttcp) getDeviceTime() utils.CommandResponse {
	var mnemonics = make([]string, 0)
	var arguments = make([]string, 0)
...
func (device *ttcp) getDopplerCompensationStatus(component string) utils.CommandResponse {
	var mnemonics = make([]string, 0)
	var arguments = make([]string, 0)
...
func (device *ttcp) setIdlePatternOn() utils.CommandResponse {
	return getSuccessResponse()
}
...
func (device *ttcp) getValue(packet []byte, command string) int {
...
func (device *ttcp) getResponseStatus(retVal []string) (string, bool) {
	if retVal == nil {
		return "Cannot Communicate with Indigeneuos TTCP", false
	}
...
func (device *ttcp) getCommandPacket(cmd utils.Command, component utils.Component) []byte {
...
func (device *ttcp) getReadPacket(component utils.Component) []byte {
	var packet = make([]byte, 0)
	header := utils.GetByteArrayForInt(1234567890)
	trailer := utils.GetByteArrayForInt(-1234567890)
...
func (device *ttcp) getToggleIdlePatternPacket() []byte {
	var packet = make([]byte, 0)
	header := utils.GetByteArrayForInt(1234567890)
	trailer := utils.GetByteArrayForInt(-1234567890)
...
func (device *ttcp) getAckAndError(response []byte) (string, bool) {
	if len(response) != 20 {
		return "", true
	}
	ack := int(response[15])
...
func (device *ttcp) getCommands(mnemonics []string, arguments []string, replace []string) []utils.Command {
